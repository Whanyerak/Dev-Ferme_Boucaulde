...
ActiveRecord::Schema.define(version: 20170604143551) do
  ...
  create_table "carts", id: :serial, force: :cascade do |t|
    ...
    t.integer "nb_butters", null: false
    t.integer "nb_cheeses", null: false
  end
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.index ["distribution_point_id"], name: "index_users_on_distribution_point_id"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
  end

  create_table "yaourts", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
